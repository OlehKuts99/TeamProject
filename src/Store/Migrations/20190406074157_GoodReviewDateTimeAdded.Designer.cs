...
namespace Store.Migrations
{
    ...
    [Migration("20190406074157_GoodReviewDateTimeAdded")]
    partial class GoodReviewDateTimeAdded
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Store.Models.Good", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Store.Models.GoodCart", b =>
                {
            ...
            modelBuilder.Entity("Store.Models.GoodOrder", b =>
                {
                    b.Property<int>("GoodId");
            ...
            modelBuilder.Entity("Store.Models.GoodReview", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Store.Models.GoodStorage", b =>
                {
                    b.Property<int>("GoodId");
            ...
            modelBuilder.Entity("Store.Models.Producer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Store.Models.Storage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Store.Models.Good", b =>
                {
                    b.HasOne("Store.Models.Producer", "Producer")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("Store.Models.GoodCart", b =>
                {
                    ...
                    b.HasOne("Store.Models.Good", "Good")
                        .WithMany("Carts")
            ...
            modelBuilder.Entity("Store.Models.GoodStorage", b =>
                {
                    ...
                    b.HasOne("Store.Models.Storage", "Storage")
                        .WithMany("Products")
